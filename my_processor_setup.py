...
def add_processors(processors):
    processors.append(StackExchangeNotificationProcessor(MetaStore("stack_exchange_1"), "My other SO filters"))
    processors.append(StackExchangeNotificationProcessor(MetaStore("stack_exchange_2"), "Java"))
    processors.append(StackExchangeNotificationProcessor(MetaStore("stack_exchange_3"), "NG"))
