...
msg1 = """Date: Sat, 9 Apr 2016 06:37:04 +0000
...
class TestConfluenceNotifications(TestCase):
    ...
    def test_two_related_notifications_can_be_rolled_up(self):
        ...
        expected_payload = """<html><body><span>You have previously read notifications up to: Apr 01 2016 06:13 PM</span>\n<table>\n  <tr style="background-color: #acf;">\n    <th>Notifications</th>\n  </tr>\n          <tr style="">\n    <td>\n      <a href="https://cwiki.apache.org/confluence/display/solr/Getting+Started?focusedCommentId=62691549">Re: Getting Started</a><br/>\n      definitely a great post  jadibd.com\n    </td>\n  </tr>          <tr><td colspan="2" style="border-bottom: 1pt solid red; border-top: 1pt solid red;"><center>^ New Notifications Since You Last Checked ^</center></td></tr>          <tr style="background-color: #def;">\n    <td>\n      <a href="https://cwiki.apache.org/confluence/display/solr/Getting+Started?focusedCommentId=62691549">Re: Getting Started</a><br/>\n      definitely a great post  jadibd.com\n    </td>\n  </tr>\n</table></body></html>"""
        ...
        self.assertEquals(calls, [
            ...
            call.store_as_binary('confluence-notifications', {1460183824: {u'space': u'solr', u'who': 'surya ferdy', u'excerpt': u'definitely a great post  jadibd.com', u'doc_text': u'Re: Getting Started', u'doc_url': u'https://cwiki.apache.org/confluence/display/solr/Getting+Started?focusedCommentId=62691549', u'event': u'surya ferdy commented on a page'}, 1460097424: {u'space': u'solr', u'line_here': True, u'who': 'C0der Extraordinaire', u'excerpt': u'definitely a great post  jadibd.com', u'doc_text': u'Re: Getting Started', u'doc_url': u'https://cwiki.apache.org/confluence/display/solr/Getting+Started?focusedCommentId=62691549', u'event': u'C0der Extraordinaire commented on a page'}}),
